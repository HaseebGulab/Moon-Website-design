class MyFooter extends HTMLElement{
  ...
  connectedCallback(){
        ...
        <div class="footer-widget pt-130 pb-130">
            <div class="container">
               ...
               <div class="col-fa1" data-aos="fade-left">
                            ...
                            <a href="../../index.html">
                                <img style="width:112px; margin:10px 10px 10px 0px;" src="images/logo-color1.png" alt="Logo">
                            </a>
                            <p class="mt-">Moon Patches provides the freedom to create and get the perfect custom patch with
                            our sincere and uninterrupted customer support.</p>
                            <ul class="sc-foot">
   ...
   <!-- container -->
 <!-- footer widget -->
        <div class="footer-copyright" style="height:80px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
